...
ScavTrap::ScavTrap(const std::string& name)
  ...
  std::cout << "ScavTrap Name Constructor for " << name << " called\n";

  getStatus();
}

ScavTrap::ScavTrap(const ScavTrap& other) : ClapTrap(other) {
  std::cout << "ScavTrap Copy constructor for " << other.m_name << " called\n";
...
ScavTrap &ScavTrap::operator=(const ScavTrap& other) {
  std::cout << "ScavTrap Copy assignment for " << other.m_name << " called\n";
  if (this != &other) {
